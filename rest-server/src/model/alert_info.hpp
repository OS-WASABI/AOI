...
struct AlertInfo {
    ...
    std::optional <std::string> effective_time; // generated upon creation
    std::optional <std::string> onset_time;     // generated upon creation
    //Optional elements
    std::optional <std::vector<aoi_rest::AlertResource>> resources;
    std::optional <std::vector<aoi_rest::AlertArea>> areas;
