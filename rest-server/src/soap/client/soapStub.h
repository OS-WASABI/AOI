...
class ns3__requestParameterList;	/* cap.h:182 */
class ns3__parameterListItem;	/* cap.h:184 */
class ns4__responseParameterList;	/* cap.h:186 */
class ns4__subParameterListItem;	/* cap.h:188 */
class _ns4__parameterListItem;	/* cap.h:190 */
class _ns5__alert_info_eventCode;	/* cap.h:546 */
class _ns5__alert_info_parameter;	/* cap.h:587 */
class _ns5__alert_info_resource;	/* cap.h:607 */
class _ns5__alert_info_area_geocode;	/* cap.h:656 */
class _ns5__alert_info_area;	/* cap.h:635 */
class _ns5__alert_info;	/* cap.h:465 */
class _ns5__alert;	/* cap.h:192 */
class _ns2__postCAPRequestTypeDef;	/* cap.h:194 */
class _ns2__CAPServiceException;	/* cap.h:196 */
class _ns2__postCAPResponseTypeDef;	/* cap.h:198 */
class _ns2__messageResponseTypeDef;	/* cap.h:200 */
class _ns2__CAPHeaderTypeDef;	/* cap.h:202 */
struct __ns2__getRequest;	/* cap.h:1076 */
struct __ns2__postCAP;	/* cap.h:1153 */
struct __ns2__getMessage;	/* cap.h:1230 */
