...
void CAPSoapHttpProxy::soap_header(_ns2__CAPHeaderTypeDef *ns2__CAPHeaderTypeDef)
{
...
int CAPSoapHttpProxy::send_getRequest(const char *soap_endpoint_url, const char *soap_action, ns3__requestParameterList *ns2__getRequestTypeDef)
{
	...
	soap_tmp___ns2__getRequest.ns2__getRequestTypeDef = ns2__getRequestTypeDef;
	soap_begin(soap);
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___ns2__getRequest(soap, &soap_tmp___ns2__getRequest);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___ns2__getRequest(soap, &soap_tmp___ns2__getRequest, "-ns2:getRequest", "")
...
int CAPSoapHttpProxy::recv_getRequest(ns4__responseParameterList &ns2__getResponseTypeDef)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns2__getResponseTypeDef.soap_get(soap, "ns2:getResponseTypeDef", NULL);
	if (soap->error)
...
int CAPSoapHttpProxy::send_postCAP(const char *soap_endpoint_url, const char *soap_action, _ns2__postCAPRequestTypeDef *ns2__postCAPRequestTypeDef)
{
	...
	soap_tmp___ns2__postCAP.ns2__postCAPRequestTypeDef = ns2__postCAPRequestTypeDef;
	soap_begin(soap);
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___ns2__postCAP(soap, &soap_tmp___ns2__postCAP);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns2__postCAP(soap, &soap_tmp___ns2__postCAP, "-ns2:postCAP", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int CAPSoapHttpProxy::recv_postCAP(_ns2__postCAPResponseTypeDef &ns2__postCAPResponseTypeDef)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns2__postCAPResponseTypeDef.soap_get(soap, "ns2:postCAPResponseTypeDef", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
int CAPSoapHttpProxy::send_getMessage(const char *soap_endpoint_url, const char *soap_action, ns3__requestParameterList *ns2__getMessageTypeDef)
{
	...
	soap_tmp___ns2__getMessage.ns2__getMessageTypeDef = ns2__getMessageTypeDef;
	soap_begin(soap);
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize___ns2__getMessage(soap, &soap_tmp___ns2__getMessage);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns2__getMessage(soap, &soap_tmp___ns2__getMessage, "-ns2:getMessage", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int CAPSoapHttpProxy::recv_getMessage(_ns2__messageResponseTypeDef &ns2__messageResponseTypeDef)
{
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns2__messageResponseTypeDef.soap_get(soap, "ns2:messageResponseTypeDef", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
