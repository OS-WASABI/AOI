...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.75 2019-02-06 21:09:52 GMT")
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns5__alert_info_area_geocode(struct soap *soap, const char *tag, int id, const _ns5__alert_info_area_geocode *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns5__alert_info_area_geocode), type))
		return soap->error;
	if (soap_out_std__string(soap, "ns5:valueName", -1, &a->_ns5__alert_info_area_geocode::valueName, ""))
		return soap->error;
	if (soap_out_std__string(soap, "ns5:value", -1, &a->_ns5__alert_info_area_geocode::value, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns5__alert_info_area(struct soap *soap, const char *tag, int id, const _ns5__alert_info_area *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns5__alert_info_area), type))
		return soap->error;
	if (soap_out_std__string(soap, "ns5:areaDesc", -1, &a->_ns5__alert_info_area::areaDesc, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOfstd__string(soap, "ns5:polygon", -1, &a->_ns5__alert_info_area::polygon, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOfstd__string(soap, "ns5:circle", -1, &a->_ns5__alert_info_area::circle, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOf_ns5__alert_info_area_geocode(soap, "ns5:geocode", -1, &a->_ns5__alert_info_area::geocode, ""))
		return soap->error;
	if (soap_out_PointerToxsd__decimal(soap, "ns5:altitude", -1, &a->_ns5__alert_info_area::altitude, ""))
		return soap->error;
	if (soap_out_PointerToxsd__decimal(soap, "ns5:ceiling", -1, &a->_ns5__alert_info_area::ceiling, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns5__alert_info_resource(struct soap *soap, const char *tag, int id, const _ns5__alert_info_resource *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns5__alert_info_resource), type))
		return soap->error;
	if (soap_out_std__string(soap, "ns5:resourceDesc", -1, &a->_ns5__alert_info_resource::resourceDesc, ""))
		return soap->error;
	if (soap_out_std__string(soap, "ns5:mimeType", -1, &a->_ns5__alert_info_resource::mimeType, ""))
		return soap->error;
	if (soap_out_PointerToxsd__integer(soap, "ns5:size", -1, &a->_ns5__alert_info_resource::size, ""))
		return soap->error;
	if (soap_out_PointerToxsd__anyURI(soap, "ns5:uri", -1, &a->_ns5__alert_info_resource::uri, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns5:derefUri", -1, &a->_ns5__alert_info_resource::derefUri, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns5:digest", -1, &a->_ns5__alert_info_resource::digest, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns5__alert_info_parameter(struct soap *soap, const char *tag, int id, const _ns5__alert_info_parameter *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns5__alert_info_parameter), type))
		return soap->error;
	if (soap_out_std__string(soap, "ns5:valueName", -1, &a->_ns5__alert_info_parameter::valueName, ""))
		return soap->error;
	if (soap_out_std__string(soap, "ns5:value", -1, &a->_ns5__alert_info_parameter::value, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns5__alert_info_eventCode(struct soap *soap, const char *tag, int id, const _ns5__alert_info_eventCode *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns5__alert_info_eventCode), type))
		return soap->error;
	if (soap_out_std__string(soap, "ns5:valueName", -1, &a->_ns5__alert_info_eventCode::valueName, ""))
		return soap->error;
	if (soap_out_std__string(soap, "ns5:value", -1, &a->_ns5__alert_info_eventCode::value, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns5__alert_info(struct soap *soap, const char *tag, int id, const _ns5__alert_info *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns5__alert_info), type))
		return soap->error;
	if (soap_out_PointerToxsd__language(soap, "ns5:language", -1, &a->_ns5__alert_info::language, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOf_ns5__alert_info_category(soap, "ns5:category", -1, &a->_ns5__alert_info::category, ""))
		return soap->error;
	if (soap_out_std__string(soap, "ns5:event", -1, &a->_ns5__alert_info::event, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOf_ns5__alert_info_responseType(soap, "ns5:responseType", -1, &a->_ns5__alert_info::responseType, ""))
		return soap->error;
	if (soap_out__ns5__alert_info_urgency(soap, "ns5:urgency", -1, &a->_ns5__alert_info::urgency, ""))
		return soap->error;
	if (soap_out__ns5__alert_info_severity(soap, "ns5:severity", -1, &a->_ns5__alert_info::severity, ""))
		return soap->error;
	if (soap_out__ns5__alert_info_certainty(soap, "ns5:certainty", -1, &a->_ns5__alert_info::certainty, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns5:audience", -1, &a->_ns5__alert_info::audience, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOf_ns5__alert_info_eventCode(soap, "ns5:eventCode", -1, &a->_ns5__alert_info::eventCode, ""))
		return soap->error;
	if (soap_out_PointerTodateTime(soap, "ns5:effective", -1, &a->_ns5__alert_info::effective, ""))
		return soap->error;
	if (soap_out_PointerTodateTime(soap, "ns5:onset", -1, &a->_ns5__alert_info::onset, ""))
		return soap->error;
	if (soap_out_PointerTodateTime(soap, "ns5:expires", -1, &a->_ns5__alert_info::expires, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns5:senderName", -1, &a->_ns5__alert_info::senderName, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns5:headline", -1, &a->_ns5__alert_info::headline, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns5:description", -1, &a->_ns5__alert_info::description, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns5:instruction", -1, &a->_ns5__alert_info::instruction, ""))
		return soap->error;
	if (soap_out_PointerToxsd__anyURI(soap, "ns5:web", -1, &a->_ns5__alert_info::web, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns5:contact", -1, &a->_ns5__alert_info::contact, ""))
		return soap->error;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns2__CAPHeaderTypeDef(struct soap *soap, const char *tag, int id, const _ns2__CAPHeaderTypeDef *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns2__CAPHeaderTypeDef), type))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns2:logonUser", -1, &a->_ns2__CAPHeaderTypeDef::logonUser, ""))
		return soap->error;
	if (soap_out_PointerToint(soap, "ns2:logonCogId", -1, &a->_ns2__CAPHeaderTypeDef::logonCogId, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns2__postCAPResponseTypeDef(struct soap *soap, const char *tag, int id, const _ns2__postCAPResponseTypeDef *a, const char *type)
{
	...
	else if (soap_out_PointerTostd__string(soap, "ns2:postCAPReturn", -1, &a->_ns2__postCAPResponseTypeDef::postCAPReturn, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns2__CAPServiceException(struct soap *soap, const char *tag, int id, const _ns2__CAPServiceException *a, const char *type)
{
	...
	else if (soap_out_PointerTostd__string(soap, "ns2:errorCode", -1, &a->_ns2__CAPServiceException::errorCode, ""))
		return soap->error;
	if (!a->_ns2__CAPServiceException::message)
	{	if (soap_element_nil(soap, "ns2:message"))
			return soap->error;
	}
	else if (soap_out_PointerTostd__string(soap, "ns2:message", -1, &a->_ns2__CAPServiceException::message, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns5__alert(struct soap *soap, const char *tag, int id, const _ns5__alert *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns5__alert), type))
		return soap->error;
	if (soap_out_std__string(soap, "ns5:identifier", -1, &a->_ns5__alert::identifier, ""))
		return soap->error;
	if (soap_out_std__string(soap, "ns5:sender", -1, &a->_ns5__alert::sender, ""))
		return soap->error;
	if (soap_out_dateTime(soap, "ns5:sent", -1, &a->_ns5__alert::sent, ""))
		return soap->error;
	if (soap_out__ns5__alert_status(soap, "ns5:status", -1, &a->_ns5__alert::status, ""))
		return soap->error;
	if (soap_out__ns5__alert_msgType(soap, "ns5:msgType", -1, &a->_ns5__alert::msgType, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns5:source", -1, &a->_ns5__alert::source, ""))
		return soap->error;
	if (soap_out__ns5__alert_scope(soap, "ns5:scope", -1, &a->_ns5__alert::scope, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns5:restriction", -1, &a->_ns5__alert::restriction, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns5:addresses", -1, &a->_ns5__alert::addresses, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOfstd__string(soap, "ns5:code", -1, &a->_ns5__alert::code, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns5:note", -1, &a->_ns5__alert::note, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns5:references", -1, &a->_ns5__alert::references, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns5:incidents", -1, &a->_ns5__alert::incidents, ""))
		return soap->error;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns4__parameterListItem(struct soap *soap, const char *tag, int id, const _ns4__parameterListItem *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns4__parameterListItem), type))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:parameterName", -1, &a->_ns4__parameterListItem::parameterName, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:parameterValue", -1, &a->_ns4__parameterListItem::parameterValue, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOfPointerTons4__subParameterListItem(soap, "ns4:subParaListItem", -1, &a->_ns4__parameterListItem::subParaListItem, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns4__subParameterListItem(struct soap *soap, const char *tag, int id, const ns4__subParameterListItem *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns4__subParameterListItem), type))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:subParameterName", -1, &a->ns4__subParameterListItem::subParameterName, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:subParameterValue", -1, &a->ns4__subParameterListItem::subParameterValue, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns4__responseParameterList(struct soap *soap, const char *tag, int id, const ns4__responseParameterList *a, const char *type)
{
	...
	if (soap_out_std__vectorTemplateOfPointerTo_ns4__parameterListItem(soap, "ns4:parameterListItem", -1, &a->ns4__responseParameterList::parameterListItem, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:ResponseOperation", -1, &a->ns4__responseParameterList::ResponseOperation, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns4:ResponseType", -1, &a->ns4__responseParameterList::ResponseType, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns3__parameterListItem(struct soap *soap, const char *tag, int id, const ns3__parameterListItem *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns3__parameterListItem), type))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns3:parameterName", -1, &a->ns3__parameterListItem::parameterName, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns3:comparisonOp", -1, &a->ns3__parameterListItem::comparisonOp, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOfstd__string(soap, "ns3:parameterValue", -1, &a->ns3__parameterListItem::parameterValue, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns3:logicalOp", -1, &a->ns3__parameterListItem::logicalOp, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns3__requestParameterList(struct soap *soap, const char *tag, int id, const ns3__requestParameterList *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns3__requestParameterList), type))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns3:requestAPI", -1, &a->ns3__requestParameterList::requestAPI, ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "ns3:requestOperation", -1, &a->ns3__requestParameterList::requestOperation, ""))
		return soap->error;
	if (soap_out_std__vectorTemplateOfPointerTons3__parameterListItem(soap, "ns3:parameters", -1, &a->ns3__requestParameterList::parameters, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_out_PointerTons3__requestParameterList(soap, "ns2:getMessageTypeDef", -1, &a->ns2__getMessageTypeDef, ""))
		return soap->error;
	return SOAP_OK;
}
...
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_out_PointerTons3__requestParameterList(soap, "ns2:getRequestTypeDef", -1, &a->ns2__getRequestTypeDef, ""))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_std__vectorTemplateOf_ns5__alert_info_responseType(struct soap *soap, const char *tag, int id, const std::vector<enum _ns5__alert_info_responseType> *a, const char *type)
{
	...
	{
		if (soap_out__ns5__alert_info_responseType(soap, tag, id, &(*i), ""))
			return soap->error;
	}
	return SOAP_OK;
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_std__vectorTemplateOf_ns5__alert_info_category(struct soap *soap, const char *tag, int id, const std::vector<enum _ns5__alert_info_category> *a, const char *type)
{
	...
	{
		if (soap_out__ns5__alert_info_category(soap, tag, id, &(*i), ""))
			return soap->error;
	}
	return SOAP_OK;
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_std__vectorTemplateOfPointerTons4__subParameterListItem(struct soap *soap, const char *tag, int id, const std::vector<ns4__subParameterListItem *> *a, const char *type)
{
	...
	for (std::vector<ns4__subParameterListItem *> ::const_iterator i = a->begin(); i != a->end(); ++i)
	{
		if (soap_out_PointerTons4__subParameterListItem(soap, tag, id, &(*i), ""))
			return soap->error;
	}
	return SOAP_OK;
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_std__vectorTemplateOfPointerTons3__parameterListItem(struct soap *soap, const char *tag, int id, const std::vector<ns3__parameterListItem *> *a, const char *type)
{
	...
	for (std::vector<ns3__parameterListItem *> ::const_iterator i = a->begin(); i != a->end(); ++i)
	{
		if (soap_out_PointerTons3__parameterListItem(soap, tag, id, &(*i), ""))
			return soap->error;
	}
	return SOAP_OK;
}
